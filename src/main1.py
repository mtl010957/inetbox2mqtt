...
HA_CONFIG = {
    ...
    "el_power_level":       ['homeassistant/sensor/el_level/config', '{"name": "TRUMA El Power Level", "unique_id": "truma_el_power_level", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "device_class": "power", "unit_of_measurement": "W", "state_topic": "' + HA_STOPIC + 'el_power_level"}'],
    ...
    "set_el_power_level":   ['homeassistant/select/el_power_level/config', '{"name": "TRUMA Set El Power Level", "unique_id": "truma_set_el_power_level", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "command_topic": "' + HA_CTOPIC + 'el_power_level", "options": ["0", "900", "1800"] }'],

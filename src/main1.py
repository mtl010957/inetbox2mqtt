...
HA_CONFIG = {
    ...
    "el_power_level":       ['homeassistant/sensor/el_level/config', '{"name": "TRUMA Electric Power Level", "unique_id": "truma_el_power_level", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "state_topic": "' + HA_STOPIC + 'el_power_level"}'],

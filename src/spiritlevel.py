...
class spirit_level:
    ...
    HA_SL_CONFIG = {
        "spirit_level_pitch":     ['homeassistant/sensor/spirit_level_pitch/config', '{"name": "Spirit Level Pitch", "unique_id": "spirit_level_pitch", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "unit_of_measurement": "°", "state_topic": "' + HA_STOPIC + 'spirit_level_pitch"}'],
        "spirit_level_roll":      ['homeassistant/sensor/spirit_level_roll/config', '{"name": "Spirit Level Roll", "unique_id": "spirit_level_roll", "model": "' + HA_MODEL + '", "sw_version":"' + HA_SWV + '", "unit_of_measurement": "°", "state_topic": "' + HA_STOPIC + 'spirit_level_roll"}'],
